  ...
  return (
    <div>
      <Form {...layout} name="nest-messages" onFinish={onFinish} validateMessages={validateMessages}>
        {/* 图片 */}
        <Image
          className='SoftwareM-image'
          width={300}
          height={300}
          src="https://img0.baidu.com/it/u=1305244557,3678730855&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500"
        ...
        {/* 简介 */}
        <Form.Item className='SoftwareM-desc' name='desc' label="简介"
          rules={[
            {
              required: true,
            },
